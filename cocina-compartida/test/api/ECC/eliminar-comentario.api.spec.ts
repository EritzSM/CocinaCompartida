...
describe('Eliminar Comentario API Frontend', () => {
  ...
  // Verifica que se envia DELETE con Authorization.
  it('EliminarComentarioApi_CuandoSolicitaDelete_DebeEnviarHeaderAuth', async () => {
    // Arrange
